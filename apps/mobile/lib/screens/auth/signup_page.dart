...
/// Handles account creation with email/password and Google sign-in
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 14),
                        AuthTextField(controller: _emailCtrl, hintText: 'Email'),
                        const SizedBox(height: 14),
                        AuthTextField(controller: _passCtrl, hintText: 'Password', obscure: true),
                        if (_error != null) ...[
